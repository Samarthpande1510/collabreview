...
const s = {
  ...
  createBtn: {
    ...
    background: "linear-gradient(135deg, rgba(255,255,255,0.3) 0%, rgba(30,80,255,0.65) 30%, rgba(10,30,180,0.8) 55%, rgba(180,60,0,0.4) 85%)",
  ...
  submitBtn: {
    ...
    cursor: "pointer",
    fontFamily: "inherit",
    boxShadow: "0 0 16px rgba(30,80,255,0.35)",
  },
